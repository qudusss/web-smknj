    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle {{ Request::routeIs('smknj.*') ? 'active' : '' }}"
                ...
                <div class="dropdown-menu m-0">
                    ...
                    <a href="{{ route('smknj.identitas') }}"
                        class="dropdown-item {{ Request::routeIs('smknj.identitas') ? 'active' : '' }}">Identitas
                        Sekolah</a>
                </div>
            </div>

            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle {{ Request::routeIs('program.*') ? 'active' : '' }}"
                    data-bs-toggle="dropdown">Program</a>
                <div class="dropdown-menu m-0">
                    <a href="{{ route('program.keahlian') }}"
                        class="dropdown-item {{ Request::routeIs('program.keahlian') ? 'active' : '' }}">Program
                        Keahlian</a>
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle {{ Request::routeIs('galeri.*') ? 'active' : '' }}"
